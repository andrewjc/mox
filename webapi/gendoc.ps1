...
$docContent | Out-File -FilePath "gendoc.txt"

# Execute examples for webhooks and append to gendoc.txt
$moxExamples = & ./mox.exe example | Select-String -Pattern 'webhook'
$exampleOutput = foreach ($ex in $moxExamples) {
	& ./mox.exe example $ex
	Write-Output ""
}
$exampleOutput | Out-File -Append -FilePath "gendoc.txt"

@"
*/
package webapi
// NOTE: DO NOT EDIT, this file is generated by gendoc.ps1.
"@ | Out-File -Append -FilePath "gendoc.txt"